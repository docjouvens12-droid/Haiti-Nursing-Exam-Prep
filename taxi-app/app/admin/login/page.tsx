...
const copy = {
  fr: {
    ...
    back: 'Retour',
    failed: 'Connexion impossible. Vérifiez votre e-mail et votre mot de passe.',
  },
  ht: {
    ...
    back: 'Retounen',
    failed: 'Koneksyon pa mache. Verifye imel ak modpas ou.',
  },
}
...
export default function AdminLoginPage() {
  ...
  return <main className="page"><section className="card">
    ...
    <form onSubmit={submit}>
      <label>{t.email}<input type="email" inputMode="email" required autoComplete="email" value={email} onChange={(e) => setEmail(e.target.value)} /></label>
