...
export default function AdminDriversPage() {
  ...
  return <main className="admin-page">
    <section className="admin-card">
      <div className="admin-top"><button onClick={() => location.href = '/'}>‹ {t.back}</button><div className="top-actions"><select value={lang} onChange={(e) => changeLang(e.target.value as Lang)}><option value="fr">Français</option><option value="ht">Kreyòl</option></select><button className="logout" onClick={() => void logout()}>{t.logout}</button></div></div>
