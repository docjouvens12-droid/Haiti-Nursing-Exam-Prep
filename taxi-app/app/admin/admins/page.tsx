...
export default function AdminManagementPage(){
  ...
  return <main className="shell"><section className="wrap">
    ...
    <article className="addCard">
      ...
      <button className="primary" disabled={busy||!email.trim()} onClick={()=>void addAdmin()}>{busy?'…':makeSuper?(lang==='ht'?'Ajoute Super Admin':'Ajouter le Super Admin'):(lang==='ht'?'Ajoute admin limite':'Ajouter l’admin limité')}</button>
    </article>
