...
export default function PassengerActiveDriver() {
  ...
  return <aside className="passenger-driver-card" aria-live="polite">
    ...
    <style jsx>{`
      .passenger-driver-card{position:fixed;left:50%;bottom:94px;transform:translateX(-50%);z-index:850;width:min(calc(100vw - 32px),720px);background:#fff;border:1px solid #dce7e3;border-radius:22px;padding:15px 16px;box-shadow:0 18px 55px rgba(16,32,51,.22);font-family:Inter,system-ui,sans-serif;color:#102033}.driver-status{font-size:12px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;color:#0f7b61;margin-bottom:10px}.driver-main{display:flex;align-items:center;gap:12px}.driver-avatar{width:52px;height:52px;border-radius:50%;overflow:hidden;background:#e6f5ef;display:grid;place-items:center;color:#0f7b61;font-size:22px;font-weight:900;flex:0 0 auto}.driver-avatar img{width:100%;height:100%;object-fit:cover}.driver-copy{min-width:0;flex:1}.driver-copy strong,.driver-copy span{display:block}.driver-copy strong{font-size:18px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.driver-copy span{font-size:13px;color:#6e7e8e;margin-top:4px;font-weight:700}.vehicle-icon{font-size:30px}.vehicle-line{display:flex;justify-content:space-between;gap:20px;margin-top:12px;padding-top:11px;border-top:1px solid #edf1f3}.vehicle-line div{min-width:0}.vehicle-line small,.vehicle-line strong{display:block}.vehicle-line small{color:#8493a1;font-size:11px}.vehicle-line strong{font-size:14px;margin-top:2px}.plate{text-align:right}@media(max-width:600px){.passenger-driver-card{bottom:82px;padding:13px 14px}.driver-avatar{width:46px;height:46px}.driver-copy strong{font-size:16px}}
    `}</style>
  </aside>
}
