  ...
  return createPortal(
    <section className={`passenger-live-top-map ${arrived ? 'arrived' : ''}`} aria-live="polite">
      <style>{`
        ...
        .passenger-live-top-map-metrics{position:absolute;left:50%;top:68px;transform:translateX(-50%);width:min(286px,calc(100% - 40px));z-index:4;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:54px 24px;background:rgba(255,255,255,.96);border:1px solid rgba(221,233,228,.95);border-radius:16px;overflow:hidden;box-shadow:0 7px 18px rgba(16,36,31,.13);backdrop-filter:blur(8px)}
        .passenger-live-top-map-metric{padding:7px 10px 6px;display:flex;flex-direction:column;justify-content:center;min-width:0}.passenger-live-top-map-metric+.passenger-live-top-map-metric{border-left:1px solid #e6eeeb}
        .passenger-live-top-map-metric span{display:block;font-size:7px;color:#5f716a;font-weight:900;text-transform:uppercase;letter-spacing:.04em;line-height:1.05;white-space:nowrap}.passenger-live-top-map-metric strong{display:block;margin-top:4px;color:#0f2438;font-size:18px;line-height:1;font-weight:950;letter-spacing:-.02em}.passenger-live-top-map-metric:first-child strong{color:#0f8065}
        .trip-endpoints{grid-column:1/-1;display:flex;align-items:center;justify-content:center;gap:10px;padding:0 7px;border-top:1px solid #eef3f1;background:rgba(248,251,250,.96);font-size:7px;font-weight:850;color:#52645e}.trip-endpoints span{display:flex;align-items:center;gap:4px;white-space:nowrap}.trip-endpoints b{width:6px;height:6px;border-radius:50%;display:inline-block}
