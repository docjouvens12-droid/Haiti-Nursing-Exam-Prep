  ...
  return createPortal(
    <section className={`passenger-live-top-map ${arrived ? 'arrived' : ''}`} aria-live="polite">
      <style>{`
        ...
        .passenger-live-top-map-metrics{position:absolute;left:12px;right:12px;top:68px;z-index:4;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:66px 27px;background:rgba(255,255,255,.96);border:1px solid rgba(221,233,228,.95);border-radius:18px;overflow:hidden;box-shadow:0 8px 24px rgba(16,36,31,.14);backdrop-filter:blur(8px)}
        .passenger-live-top-map-metric{padding:9px 13px 7px;display:flex;flex-direction:column;justify-content:center;min-width:0}.passenger-live-top-map-metric+.passenger-live-top-map-metric{border-left:1px solid #e6eeeb}
        .passenger-live-top-map-metric span{display:block;font-size:9px;color:#5f716a;font-weight:900;text-transform:uppercase;letter-spacing:.045em;line-height:1.1}.passenger-live-top-map-metric strong{display:block;margin-top:5px;color:#0f2438;font-size:23px;line-height:1;font-weight:950;letter-spacing:-.02em}.passenger-live-top-map-metric:first-child strong{color:#0f8065}
        .trip-endpoints{grid-column:1/-1;display:flex;align-items:center;justify-content:center;gap:14px;padding:0 9px;border-top:1px solid #eef3f1;background:rgba(248,251,250,.96);font-size:8px;font-weight:850;color:#52645e}.trip-endpoints span{display:flex;align-items:center;gap:5px;white-space:nowrap}.trip-endpoints b{width:7px;height:7px;border-radius:50%;display:inline-block}
        ...
        @media(max-width:390px){.passenger-live-top-map-metric strong{font-size:21px}.passenger-live-top-map-metric span{font-size:8px}}
      `}</style>
