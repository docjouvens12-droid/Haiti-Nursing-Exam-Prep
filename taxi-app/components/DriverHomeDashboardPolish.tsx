...
export default function DriverHomeDashboardPolish(){
  ...
  return createPortal(<>
    <style>{`
      .driver-home-polish{margin:14px 0 16px}.driver-home-map-shell{height:310px;border-radius:24px;overflow:hidden;position:relative;background:#e9eff3;border:1px solid #dce5ea;box-shadow:0 10px 28px rgba(16,32,51,.08)}.driver-home-map{width:100%;height:100%}.driver-home-map-label{position:absolute;left:14px;top:14px;z-index:3;background:rgba(255,255,255,.94);backdrop-filter:blur(8px);border-radius:999px;padding:9px 13px;font-size:12px;font-weight:900;color:#102033;box-shadow:0 4px 14px rgba(0,0,0,.08)}.driver-home-map-fallback{height:100%;display:grid;place-items:center;text-align:center;padding:20px;color:#617281;font-weight:800}.driver-home-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:12px}.driver-home-stat{background:#fff;border:1px solid #e0e7eb;border-radius:18px;padding:13px 10px;min-width:0;box-shadow:0 5px 16px rgba(16,32,51,.04)}.driver-home-stat small,.driver-home-stat strong{display:block}.driver-home-stat small{font-size:10px;color:#7d8b98;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.driver-home-stat strong{margin-top:6px;font-size:16px;color:#102033}.driver-home-stat span{font-size:15px;margin-right:4px}.driver-home-marker{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:#fff;border:3px solid #0f705a;box-shadow:0 5px 14px rgba(0,0,0,.2);font-size:21px}.driver-rating-card{display:none!important}.online-card{border:0!important;box-shadow:0 8px 24px rgba(16,32,51,.08)!important;border-radius:22px!important;padding:17px 18px!important}.section-title{margin-top:20px!important}.ride-card{box-shadow:0 7px 22px rgba(16,32,51,.055)!important;border-radius:20px!important}.primary{min-height:48px!important;border-radius:15px!important}@media(max-width:560px){.driver-home-map-shell{height:285px}.driver-home-stats{gap:8px}.driver-home-stat{padding:12px 8px}.driver-home-stat strong{font-size:14px}}
    `}</style>
