...
export default async function Page(){
  ...
  return <main style={{maxWidth:940,margin:'0 auto',padding:'26px 18px 90px'}}>
    ...
    <header style={{margin:'18px 0 22px',background:'linear-gradient(135deg,#14532d,#16a34a)',color:'white',borderRadius:22,padding:'28px 24px'}}>
      <div style={{opacity:.84,fontSize:13,fontWeight:900,letterSpacing:1}}>PHARMACOLOGIE • ANTI-INFECTIEUX</div>
    ...
    <section style={{background:'#fff7ed',border:'1px solid #fed7aa',borderRadius:18,padding:20,marginBottom:22}}>
      ...
      <p style={{margin:0,color:'#475569',lineHeight:1.72}}>Anaphylaxie, rash sévère avec atteinte des muqueuses, diarrhée importante après antibiothérapie, acouphènes sous aminoglycoside, douleur tendineuse sous fluoroquinolone ou aggravation de la fonction rénale nécessitent une réévaluation rapide.</p>
    </section>
