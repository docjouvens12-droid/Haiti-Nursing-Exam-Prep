    ...
    <>
      ...
      <style jsx global>{`
        ...
        @media(max-width:800px){
          ...
          .mobile-drawer-head strong{display:block;color:#0b1f59;font-size:18px}
          .mobile-drawer-head span{display:block;color:#71809e;font-size:11px;margin-top:2px}
          ...
          .mobile-drawer-nav{display:grid;gap:5px;padding:14px 0}
          .mobile-drawer-nav a{display:flex;align-items:center;gap:13px;padding:13px 14px;border-radius:11px;color:#172442;font-size:14px;font-weight:700}
          .mobile-drawer-nav a>span:first-child{width:24px;text-align:center;color:#4561e8;font-size:18px}
          .mobile-drawer-nav a.active{background:#eef4ff;color:#1f5fe8}
          .mobile-drawer-nav a.mobile-drawer-admin{background:#eff8f3;color:#137a4d;margin-top:6px}
          .mobile-drawer-nav a.mobile-drawer-admin>span:first-child{color:#137a4d}
